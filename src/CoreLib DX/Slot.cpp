...
Slot::Slot(const wstring_view& myName, const EObjType& objType,
	...
	m_pMyItem(nullptr), m_itemCount(0)
{
	//Init();
}
...
bool Slot::Init() noexcept
{
	...
	CreateVertexBuffer(DxManager::Instance->m_pD3dDevice, &m_pDragBuffer, &m_DragVertexList);
	m_DragRect = *this;
	return true;
}
